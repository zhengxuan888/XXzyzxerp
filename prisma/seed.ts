...
const actionDefs: SeedAction[] = [
  ...
  { key: "finance.remittance_admin.read", name: "查看管理员回款数据", namespace: "finance", scope: "ALL" },
...
const menuDefs = [
  ...
  {
    key: "after-sales-report",
    label: "售后日报",
    path: "/admin/after-sales-report",
    requiredActionKey: "shipment.read",
    sortOrder: 132,
    isActive: true,
  },
  ...
  {
    key: "finance-remittances",
    label: "回款数据",
    path: "/admin/finance-remittances",
    requiredActionKey: "finance.remittance_admin.read",
    sortOrder: 145,
    isActive: true,
  },
  {
...
const menuGroupByKey: Record<string, (typeof menuGroupDefs)[number]["key"]> = {
  ...
  "after-sales-report": "group-logistics",
...
async function main() {
  const countrySeed = [
    ["AL", "阿尔巴尼亚"], ["AD", "安道尔"], ["AT", "奥地利"], ["BY", "白俄罗斯"], ["BE", "比利时"], ["IS", "冰岛"], ["BA", "波斯尼亚和黑塞哥维那"], ["BG", "保加利亚"], ["PL", "波兰"], ["DK", "丹麦"], ["DE", "德国"], ["RU", "俄罗斯"], ["FR", "法国"], ["VA", "梵蒂冈"], ["FI", "芬兰"], ["GE", "格鲁吉亚"], ["ME", "黑山"], ["NL", "荷兰"], ["CZ", "捷克"], ["HR", "克罗地亚"], ["LV", "拉脱维亚"], ["LT", "立陶宛"], ["LI", "列支敦士登"], ["LU", "卢森堡"], ["RO", "罗马尼亚"], ["MT", "马耳他"], ["MK", "北马其顿"], ["MD", "摩尔多瓦"], ["MC", "摩纳哥"], ["NO", "挪威"], ["PT", "葡萄牙"], ["SE", "瑞典"], ["CH", "瑞士"], ["RS", "塞尔维亚"], ["CY", "塞浦路斯"], ["SM", "圣马力诺"], ["SK", "斯洛伐克"], ["SI", "斯洛文尼亚"], ["TR", "土耳其"], ["UA", "乌克兰"], ["ES", "西班牙"], ["GR", "希腊"], ["HU", "匈牙利"], ["AM", "亚美尼亚"], ["AZ", "阿塞拜疆"], ["IT", "意大利"], ["GB", "英国"], ["EE", "爱沙尼亚"], ["IE", "爱尔兰"], ["XK", "科索沃"],
    ["US", "美国"], ["CA", "加拿大"], ["SG", "新加坡"], ["MY", "马来西亚"], ["AU", "澳大利亚"], ["NZ", "新西兰"],
  ] as const;
  ...
  const roleProfiles: Array<{
    ...
    { code: "demo_after_sales", name: "演示物流售后员", username: "demo_after_sales", email: "demo.after.sales@local.erp", allowed: ["dashboard.view", "customer.read", "order.read", "order.ship", "shipment.read", "shipment.create", "shipment.tracking_no.view", "shipment.timeline.view", "shipment.track.update", "logistics_template.read", "logistics_template.export", "logistics.export_batch.read", "logistics.export_batch.create", "logistics.export_batch.dispatch", "logistics.return_import.preview", "logistics.return_import.confirm", "logistics.batch_artifact.read", "inbox.read", "inbox.manage", "inbox.assign", "inbox.customer.link", "attachment.read", "attachment.create"] },
